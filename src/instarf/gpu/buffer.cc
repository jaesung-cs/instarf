...
BufferBase::BufferBase(const Device& device, VkBufferUsageFlags usage,
  ...
  vmaCreateBuffer(allocator_, &bufferInfo, &allocationCreateInfo, &buffer_,
                  &allocation_, nullptr);
  ...
  if (ptr) {
    ...
    vmaCreateBuffer(allocator_, &bufferInfo, &allocationCreateInfo,
